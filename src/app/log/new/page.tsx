...
export default function NewLogPage() {
  ...
  const [form, setForm] = useState({
    ...
    date: new Date().toISOString().split('T')[0], categoryId: '', roleId: '', secondaryRoleIds: [] as number[],
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error || 'Failed to create entry.'); setLoading(false); return }
  ...
  if (status === 'loading') return <div className="container py-5 text-center"><div className="spinner-border text-primary"></div></div>
        ...
        <div className="col-md-8">
          <div className="card shadow">
            <div className="card-header bg-white">
              <h4 className="mb-0"><i className="bi bi-plus-circle me-2 text-primary"></i>New Log Entry</h4>
            </div>
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  <label className="form-label">Secondary Roles (optional, hold Ctrl/Cmd to select multiple)</label>
                ...
                <div className="d-flex gap-2">
                  <button type="submit" className="btn btn-primary" disabled={loading}>
                    {loading ? <><span className="spinner-border spinner-border-sm me-1"></span>Saving...</> : <><i className="bi bi-check-lg me-1"></i>Save Entry</>}
                  </button>
